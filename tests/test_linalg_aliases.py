...
"""Tests for linalg namespace aliases that delegate to top-level flopscope ops."""
...
class TestLinalgMatmul:
    def test_result_matches_numpy(self):
        ...
        with BudgetContext(flop_budget=10**6):
            from flopscope.numpy.linalg import matmul
...
class TestLinalgCross:
    def test_result_matches_numpy(self):
        ...
        with BudgetContext(flop_budget=10**6):
            from flopscope.numpy.linalg import cross
...
class TestLinalgOuter:
    def test_result_matches_numpy(self):
        ...
        with BudgetContext(flop_budget=10**6):
            from flopscope.numpy.linalg import outer
...
class TestLinalgTensordot:
    def test_result_matches_numpy(self):
        ...
        with BudgetContext(flop_budget=10**6):
            from flopscope.numpy.linalg import tensordot
...
class TestLinalgVecdot:
    def test_result_matches_numpy(self):
        ...
        b = numpy.array([4.0, 5.0, 6.0])
        with BudgetContext(flop_budget=10**6):
            from flopscope.numpy.linalg import vecdot
...
class TestLinalgDiagonal:
    ...
    def test_scan_cost(self):
        ...
        with BudgetContext(flop_budget=10**6) as budget:
            ...
            diagonal(A)
            assert budget.flops_used == 0  # view; 0 FLOPs (numpy.diagonal returns a read-only view)
...
class TestLinalgMatrixTranspose:
    def test_result_matches_numpy(self):
        ...
        with BudgetContext(flop_budget=10**6):
            from flopscope.numpy.linalg import matrix_transpose
